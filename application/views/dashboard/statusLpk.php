                                                ...
                                                <?php foreach ($query15 as $a) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" value="<?= $a['nama_program']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Inisiator</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $a['inisiator_program']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Durasi Pelatihan</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $a['durasi_pelatihan_program']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Standar Kompetensi</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $a['standar_kompetensi_program']; ?>">
                                                        </div>
                                            ...
                                            <div class="form-biasa">
                                                <?php foreach ($query16 as $b) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <label  for="field-name">Nama Program</label>
                                                            <input type="text" class="form-control" id="field-name" value="<?= $b['nama_program_penyelenggara']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal Pelaksanaan</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $b['jadwal_pelaksanaan_penyelenggara']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Peserta</label>
                                                            <input type="number" class="form-control" id="field-value" value="<?= $b['jumlah_peserta_penyelenggara']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Lulusan</label>
                                                            <input type="number" class="form-control" id="field-value" value="<?= $b['jumlah_lulusan_penyelenggara']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Keterangan</label>
                                                            <textarea class="form-control" name="keterangan_penyelenggara[]"><?= $b['keterangan_penyelenggara']; ?></textarea>
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>  <!-- /div.form-biasa -->
                                                ...
                                                <?php foreach ($query17 as $c) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" value="<?= $c['nama_lsp']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Skema Sertifikasi</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $c['skema_sertifikasi_lsp']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal Pelaksanaan</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $c['jadwal_pelaksanaan_lsp']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Peserta</label>
                                                            <input type="number" class="form-control" id="field-value" value="<?= $c['jumlah_peserta_lsp']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Keterangan</label>
                                                            <textarea class="form-control" name="keterangan_lsp[]"><?= $c['keterangan_lsp']; ?></textarea>
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>  <!-- /div.form-biasa -->
                                                ...
                                                <?php foreach ($query18 as $d) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" value="<?= $d['nama_kegiatan_sdm']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $d['jadwal_sdm']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Lokasi</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Lokasi" value="<?= $d['lokasi_sdm']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Penyelenggara</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $d['penyelenggara_sdm']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Keterangan</label>
                                                            <textarea class="form-control" name="keterangan_sdm[]"><?= $d['keterangan_sdm']; ?></textarea>
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>  <!-- /div.form-biasa -->
                                                ...
                                                <?php foreach ($query19 as $e) { ?>
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" value="<?= $e['nama_mitra']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Alamat</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $e['alamat_mitra']; ?>">
                                                        </div>

                                                        <div class="form-group">
                                                            <label  for="field-value">Bentuk Kemitraan</label>
                                                            <input type="text" class="form-control" id="field-value" value="<?= $e['bentuk_kemitraan']; ?>">
                                                        </div>
                                                    </fieldset>
                                                <?php } ?>
                                            </div>  <!-- /div.form-biasa -->
