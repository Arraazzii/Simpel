                    ...
                    <div class="modal-body">
                        <div class="tab tab-border nav-center">
                            ...
                            <div class="tab-content">
                                    ...
                                    <fieldset class="col-md-12 mt-10">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $row->nama; ?>" name="nama" class="form-control" placeholder="Nama LPK/BLKLN" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $row->telepon; ?>" name="no_telepon" class="form-control" placeholder="No. Telepon" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">Email <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="email" value="<?= $row->email; ?>" name="email" class="form-control" placeholder="Email" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">No. Izin <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->no_izin; ?>" name="no_izin" class="form-control" placeholder="No. Izin" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">Tanggal Izin <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="date" value="<?= $row->tanggal_izin; ?>" name="tanggal_izin" class="form-control" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $row->status_akreditas; ?>" name="status_akreditas" class="form-control" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">No. Akreditas <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->no_akreditas; ?>" name="no_akreditas" class="form-control" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">Ruang Lingkup <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->ruang_lingkup; ?>" name="ruang_lingkup" class="form-control" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                    ...
                                    <fieldset class="col-md-12 mt-10">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $row->nama_pimpinan; ?>" name="nama_pimpinan" class="form-control" placeholder="Nama Pimpinan" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">No. Telepon Pimpinan <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->no_telepon_pimpinan; ?>" name="no_telepon_pimpinan" class="form-control" placeholder="(+62) ..." required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">Nama Penanggung Jawab <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->nama_pj; ?>" name="nama_pj" class="form-control" placeholder="Nama Pimpinan" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">Jabatan Penanggung Jawab <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->jabatan_pj; ?>" name="jabatan_pj" class="form-control" placeholder="Nama Pimpinan" required="" />
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="control-label">No. Telepon Penanggung Jawab <span style="color:red" title="Wajib Diisi">*</span></label>
                                                <input type="text" value="<?= $row->no_telepon_pj; ?>" name="no_telepon_pj" class="form-control" placeholder="(+62) ..." required="" />
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset class="col-md-12 mt-10">
                                        ...
                                        <table class="table table-striped">
                                            <center>
                                                ...
                                                <tr>
                                                    <td>Karyawan</td>
                                                    <td><input type="number" name="karyawan_laki" class="form-control" value="<?= $query1[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="karyawan_perempuan" class="form-control" value="<?= $query2[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Tenaga Pelatihan Tetap</td>
                                                    <td><input type="number" name="tpt_laki" class="form-control" value="<?= $query3[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="tpt_perempuan" class="form-control" value="<?= $query4[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Tenaga Pelatihan Tidak Tetap</td>
                                                    <td><input type="number" name="tptt_laki" class="form-control" value="<?= $query5[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="tptt_perempuan" class="form-control" value="<?= $query6[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Instruktur Tetap</td>
                                                    <td><input type="number" name="it_laki" class="form-control" value="<?= $query7[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="it_perempuan" class="form-control" value="<?= $query8[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Instruktur Tidak Tetap</td>
                                                    <td><input type="number" name="itt_laki" class="form-control" value="<?= $query9[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="itt_perempuan" class="form-control" value="<?= $query10[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Asesor Kompetensi</td>
                                                    <td><input type="number" name="ak_laki" class="form-control" value="<?= $query11[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="ak_perempuan" class="form-control" value="<?= $query12[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                                <tr>
                                                    <td>Instruktur/Asesor WNA</td>
                                                    <td><input type="number" name="aw_laki" class="form-control" value="<?= $query13[0]['jumlah']; ?>" required="" /></td>
                                                    <td><input type="number" name="aw_perempuan" class="form-control" value="<?= $query14[0]['jumlah']; ?>" required="" /></td>
                                                </tr>
                                            </center>
                                        </table>
                                    </fieldset>
                                </div>
                                <div class="tab-pane fade active" id="pengembangan-pelatihan" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-biasa">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" placeholder="Nama Program" name="nama_program[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Inisiator</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Inisiator" name="inisiator_program[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Durasi Pelatihan</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Durasi Pelatihan" name="durasi_pelatihan_program[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Standar Kompetensi</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Standar Kompetensi" name="standar_kompetensi_program[]">
                                                        </div>
                                ...
                                <div class="tab-pane fade active" id="penyelenggaraan-pelatihan" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div data-role="dynamic-fields">
                                                <div class="form-biasa">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <label  for="field-name">Nama Program</label>
                                                            <input type="text" class="form-control" id="field-name" placeholder="Nama Program" name="nama_program_penyelenggara[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal Pelaksanaan</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Jadwal Pelaksanaan" name="jadwal_pelaksanaan_penyelenggara[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Peserta</label>
                                                            <input type="number" class="form-control" id="field-value" name="jumlah_peserta_penyelenggara[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Lulusan</label>
                                                            <input type="number" class="form-control" id="field-value" name="jumlah_lulusan_penyelenggara[]">
                                                        </div>
                                                ...
                                                <div class="form-biasa">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" placeholder="Nama LSP" name="nama_lsp[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Skema Sertifikasi</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Skema Sertifikasi" name="skema_sertifikasi_lsp[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal Pelaksanaan</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Jadwal Pelaksanaan" name="jadwal_pelaksanaan_lsp[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jumlah Peserta</label>
                                                            <input type="number" class="form-control" id="field-value" name="jumlah_peserta_lsp[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Keterangan</label>
                                                            <textarea class="form-control" name="keterangan_lsp[]"></textarea>
                                                        </div>
                                                        <button class="btn btn-danger m-2 float-right" data-role="remove">
                                                            -
                                                        </button>
                                                ...
                                                <div class="form-biasa">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" placeholder="Nama Kegiatan" name="nama_kegiatan_sdm[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Jadwal</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Jadwal" name="jadwal_sdm[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Lokasi</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Lokasi" name="lokasi_sdm[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Penyelenggara</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Penyelenggara" name="penyelenggara_sdm[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Keterangan</label>
                                                            <textarea class="form-control" name="keterangan_sdm[]"></textarea>
                                                        </div>
                                                        <button class="btn btn-danger m-2 float-right" data-role="remove">
                                                            -
                                                        </button>
                                                ...
                                                <div class="form-biasa">
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="field-name" placeholder="Nama Mitra" name="nama_mitra[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Alamat</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Alamat" name="alamat_mitra[]">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <label  for="field-value">Bentuk Kemitraan</label>
                                                            <input type="text" class="form-control" id="field-value" placeholder="Bentuk Kemitraan" name="bentuk_kemitraan[]">
                                                        </div>
                                                        <button class="btn btn-danger m-2 float-right" data-role="remove">
                                                            -
                                                        </button>
