                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    <div class="form-group">
                                        <label>No. Izin</label>
                                        <input type="text" name="no_izin" value="<?= $row->no_izin ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal izin</label>
                                        <input type="date" name="tgl_izin" value="<?= $row->tanggal_izin ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Telepon</label>
                                        <input type="text" name="no_telepon" value="<?= $row->telepon ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                ...
                                <div class="tab-pane fade" id="pengurus" role="tabpanel" aria-labelledby="pengurus-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_pimpinan" value="<?= $row->nama_pimpinan ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>No Direktur Lembaga</label>
                                        <input type="text" name="no_telepon_pimpinan" value="<?= $row->no_telepon_pimpinan ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Nama Penanggung Jawab Lembaga</label>
                                        <input type="text" name="nama_pj" value="<?= $row->nama_pj ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Jabatan Penanggung Jawab Lembaga</label>
                                        <input type="text" name="jabatan_pj" value="<?= $row->jabatan_pj ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>No Penanggung Jawab Lembaga</label>
                                        <input type="text" name="no_telepon_pj" value="<?= $row->no_telepon_pj ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ruang_lingkup" value="<?= $row->ruang_lingkup; ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Status Akreditasi</label>
                                        <input type="text" name="status_akreditas" value="<?= $row->status_akreditas; ?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>No. Akreditasi</label>
                                        <input type="text" name="no_akreditas" value="<?= $row->no_akreditas; ?>" class="form-control">
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query1[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query2[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query3[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query4[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query5[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query6[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query7[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query8[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query9[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query10[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query11[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query12[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query13[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" name="jumlah[]" value="<?= $query14[0]['jumlah']; ?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
